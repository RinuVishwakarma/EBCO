...
import SmartSolutionCard from '@/utils/SmartSolution'
        ...
        <Box className='home-page'>
          ...
          <Box className='smart-solutions row-space-between'>
            <Box className='smart-solutions-title' sx={{ padding: '1rem' }}>
              ...
              >
                <Typography
                  className='smart_solution_title desktop-text'
                  style={{
                    ...lightTextHeadingStyle,
                    color: customColors.whiteEbco,
                  }}
                >
                  EXPLORE
            ...
            <Box className='smart-solutions-products row-space-around'>
              {smartSolutionsQuery.isLoading ? (
                ...
                smartSolutionsQuery?.data?.map((item, i) => {
                  return (
                    <SmartSolutionCard
                      item={item}
                      handleSmartSolution={handleSmartSolution}
                      i={i}
                      key={i}
                    />
                  )
